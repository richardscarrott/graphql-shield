...
export declare const rule: (
  name?: string | IRuleConstructorOptions | undefined,
  options?: IRuleConstructorOptions | undefined,
...
export declare const inputRule: <T>(
  ...
  schema: (yup: typeof Yup) => Yup.Schema<T, object>,
  options?: Yup.ValidateOptions<object> | undefined,
) => InputRule<T>
/**
 *
 * @param rules
